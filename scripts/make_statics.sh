...
BETTERIMAGEDIR=~/projects/django-better-image/django_better_image
BICSSDIR=$BETTERIMAGEDIR/static/django_modals/css
BIJSDIR=$BETTERIMAGEDIR/static/django_modals/js
...
DJANGO_MODALS_JS=$JSDIR/djmodals_utils.js
DJANGO_MODALS_MIN_JS=$JSDIR/djmodals_utils.min.js
...
if [[ -d $JSDIR ]]
then
    cp $JSDIR/util.js $DJANGO_MODALS_JS
    echo >> $DJANGO_MODALS_JS
    cat $JSDIR/modal.js >> $DJANGO_MODALS_JS
    echo "generated : $DJANGO_MODALS_JS"
