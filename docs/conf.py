...
project = u'django-modals'
copyright = u'2019, Eric Lapouyade'
...
pdf_documents = [('index', u'django-modals_pdf', u'django-modals', u'Eric Lapouyade'),]
...
latex_documents = [
  ('index', 'django-modals.tex', u'django-modals Documentation',
...
man_pages = [
    ('index', 'django-modals', u'django-modals Documentation',
     [u'Eric Lapouyade'], 1)
]
...
texinfo_documents = [
  ('index', 'django-modals', u'django-modals Documentation',
   u'Eric Lapouyade', 'best-templatetags', 'django-modals library.',
   'Miscellaneous'),
]
